...
El proyecto trata de un pequeño juego en la web en el que es un sorteo para un amigo secreto, donde ingresas un conjunto de nombres para que salga aleatoreamente el ganador.
